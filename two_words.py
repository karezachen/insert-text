...
INPUT_PATH = os.path.join(ROOT_PATH, 'two_words_input')
OUTPUT_PATH = os.path.join(ROOT_PATH, '../insert-text-web/public/two_words_output') 
RED_BOX_PATH = os.path.join(ROOT_PATH, 'two_words_red_box')
